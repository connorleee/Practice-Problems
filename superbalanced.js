...
function isBalanced(treeRoot) {
    ...
    // List of nodes that we've popped off and want to observe. this is a stack 
    let nodes = [];

    // We are creating node pairs. nodePair[0] is the treeNode, and nodePair[1] is a count of depth.
    ...
    while (nodes.length) {
        ...
        // If we're not at a leaf node, keep traversing
        } else {
            if (node.left) {
